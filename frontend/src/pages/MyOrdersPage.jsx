...
const MyOrdersPage = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 sm:p-6">
            <h2 className="text-xl sm:text-2xl font-bold mb-6"></h2>
                    ...
                    <tbody>
                        {orders.length > 0 ? (
                            orders.map((order) => (
                                ...
                                >
                                    <td className="py-2 px-2 sm:py-4 sm:px-4 align-middle">
                                        <img
                                    ...
                                    <td className="py-2 px-2 sm:py-4 sm:px-4 align-middle min-w-[100px]">
                                        <span
