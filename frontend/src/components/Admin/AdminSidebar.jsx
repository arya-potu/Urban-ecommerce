...
const AdminSidebar = () => {
  ...
  return (
    <div className='p-6 '>
        <div className='mb-6 '>
            <Link to="/admin" className='text-2xl font-medium'>Urban</Link>
        </div>
        ...
        <nav className='flex flex-col space-y-2'>
            ...
            <NavLink to="/admin/Shop" className={({isActive}) => isActive ? "bg-gray-700 text-white py-3 px-4 rounded flex items-center space-x-2" : "text-gray-300 hover:bg-gray-700 text-white py-3 px-4 rounded flex items-center space-x-2"}>
            <FaStore />
            <span>Shop</span>
            </NavLink>
