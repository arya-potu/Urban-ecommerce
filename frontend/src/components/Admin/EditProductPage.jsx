...
const [tempColors, setTempColors] = useState("");
   ...
   useEffect(() => {
       if (selectedProduct) {
           ...
           setTempSizes(selectedProduct.sizes.join(", "));
           setTempColors(selectedProduct.colors.join(", "));
       }
   }, [selectedProduct]);
...
<div className='mb-6'>
  ...
  <input
    ...
    onChange={(e) => {
      ...
      setProductData({
        ...productData,
        sizes: val.split(",").map((size) => size.trim()),
      });
    }}
    className='w-full border border-gray-300 rounded-md p-2'
  />
...
<div className='mb-6'>
  ...
  <input
    ...
    onChange={(e) => {
      ...
      setProductData({
        ...productData,
        colors: val.split(",").map((color) => color.trim()),
      });
    }}
    className='w-full border border-gray-300 rounded-md p-2'
  />
